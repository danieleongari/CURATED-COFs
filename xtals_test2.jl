...
# ╔═╡ 3fe5dbfc-12b5-11ed-2406-33476b23c3f9
using Graphs, PlutoUI, Xtals

# ╔═╡ d5b6ae90-43be-4672-a660-7964cb1c8d75
rc[:paths][:crystals] = "cifs"

# ╔═╡ 18a37141-e561-4e40-9a02-ed8356ec1435
xtal_names = readlines("./bond_anomalies.txt")

# ╔═╡ 32873100-1a68-482b-9a51-077214aefd42
@bind xtal_idx NumberField(1:length(xtal_names))

# ╔═╡ eab4ebba-1c83-45b8-989e-00e1a6effef0
begin
	xtal = Crystal(xtal_names[xtal_idx])
	infer_bonds!(xtal, true)
end

# ╔═╡ fdbdc1ba-cc7e-4814-ac4f-546f865fcb36
@info "" [(v, xtal.atoms.species[v]) for v in neighbors(xtal.bonds, 8)]

# ╔═╡ 786d849f-0911-423c-a64c-cfec90e773f8
bogus_C = xtal_names[[59]]

# ╔═╡ 0e310064-17d2-4dd1-a943-19582fc07200
bogus_H = xtal_names[[2, 4, 11, 36, 48, 50, 51, 56, 57, 60, 63, 64]]

# ╔═╡ e8ba0ae3-dd70-4683-8a3d-85f1b14f47da
close_contacts = xtal_names[[1, 7, 16, 20, 23, 30, 32, 33, 37, 38, 39, 40, 41, 42, 44, 45, 46, 47]]

# ╔═╡ 2892f5ae-7d1a-40f3-9e93-485e4cfd7e32
long_bonds = xtal_names[[3, 5, 19, 21, 25, 26, 27, 28, 29, 31, 34, 35, 43, 49, 52, 58, 61]]

# ╔═╡ 6e0dd6ec-65e0-47a3-9d8e-b95e23951502
false_positives = xtal_names[[6, 8, 9, 10, 12, 13, 14, 15, 17, 18, 22, 24, 53, 54, 55, 62]]

# ╔═╡ 88b48b61-752a-4c8d-85a7-b22d687de5b1
run(`avogadro ./cifs/$(xtal.name)`)

# ╔═╡ 26bdaf49-c8cb-4318-b6b9-69cea41c2bd9
@assert sort(union(bogus_C, bogus_H, long_bonds, false_positives, close_contacts)) == sort(xtal_names) "Every input should be categorized!"
